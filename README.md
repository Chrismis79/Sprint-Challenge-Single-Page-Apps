...
> Answer:  Client-side routiing allows for instant loading of 'pages' inside the app. It loads once and everything is there, the page doesn't have to refresh to load.
